    ...
    <div nz-col *ngFor="let overviewData of filteredOverviewData" class="mb-[25px]" nzXs="24" nzMd="12" nzXXl="6">
      <div bordered="false"
        ...
        <div class="flex justify-between">
          <div
            class="flex items-center justify-center order-0 bg-{{ overviewData.type }}/10 text-{{ overviewData.type }} w-[58px] h-[58px] rounded-2xl">
            <div
...
export class OverviewSevenComponent {
